...
const PropertyLovedList = () => {
  return (
    <div classame="lovedList">
      ...
      <PropertyLovedListItem imgUrl="https://q-xx.bstatic.com/xdata/images/hotel/max500/40890517.jpg?k=5d3943f506472669a73f5db0bdb30066dd10d6234c2082ed10da3d6bc8220c6b&o=" name="Appartamento Benincampi" city="Roma" price={1.485} rating={9.7} avaliation="" />
      <PropertyLovedListItem imgUrl="https://pix10.agoda.net/hotelImages/908/908884/908884_15042118230027007981.jpg?ca=4&ce=1&s=1024x768" name="LivinParis - Luxury 3 Bedrooms Le Louvre" city="Paris" price={2.615} rating={8.2} avaliation="Muito bom" />
    </div>
  )
}
